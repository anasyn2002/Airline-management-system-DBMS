...
urlpatterns = [
    ...
    path('flights/<int:pk>/update/',
         views.FlightUpdateView.as_view(), name='flight-update'),

    # Passengers
    path('passengers/', views.PassengerListView.as_view(), name='passenger-list'),
    path('passengers/<int:pk>/', views.PassengerDetailView.as_view(),
         name='passenger-detail'),
    path('passengers/create/', views.PassengerCreateView.as_view(),
    ...
    path('bookings/<int:pk>/confirm/',
         views.confirm_booking, name='booking-confirm'),
    path('bookings/<int:pk>/cancel/', views.cancel_booking, name='cancel_booking'),
    path('bookings/<int:pk>/download-boarding-pass/',
         views.download_boarding_pass, name='download_boarding_pass'),
    path('bookings/<int:pk>/download-boarding-pass/', views.download_boarding_pass, name='download-boarding-pass'),
    ...
    # Boarding Passes
    path('boarding-passes/', views.BoardingPassListView.as_view(),
         name='boarding-pass-list'),
    path('boarding-passes/create/', views.BoardingPassCreateView.as_view(),
         name='boarding-pass-create'),
    ...
    path('schedules/<int:pk>/edit/',
         views.ScheduleUpdateView.as_view(), name='schedule-edit'),
]
