...
class PassengerForm(forms.ModelForm):
    class Meta:
        model = Passenger
        fields = ['name', 'date_of_birth', 'gender', 'email', 'phone_number', 'passport_number', 'address']
        widgets = {
...
class FlightForm(forms.ModelForm):
    class Meta:
        model = Flight
        fields = ['flight_number', 'departure_time', 'arrival_time', 'source_airport', 'destination_airport', 'aircraft', 'crew']
        widgets = {
